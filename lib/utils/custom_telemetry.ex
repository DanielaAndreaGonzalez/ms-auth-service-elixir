defmodule AuthApi.Utils.CustomTelemetry do
  alias AuthApi.Utils.DataTypeUtils
  alias AuthApi.Utils.CustomTelemetry
  import Telemetry.Metrics
  require Logger

  @service_name Application.compile_env!(:auth_api, :custom_metrics_prefix_name)
  ...
  def handle_custom_event([:auth_api, :plug, :stop], measures, metadata, _) do
    :telemetry.execute(
