defmodule AuthApi.Utils.CustomTelemetryTest do
  ...
  test "handle_custom_event adds service name to metadata" do
    ...
    Application.put_env(:auth_api, :service_name, service_name)
  ...
  test "execute_custom_event emits the correct event with default metadata" do
    metric = [:custom, :event]
    value = 200
    expected_metadata = %{service: "auth_api_test"}
